...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'project_create.create': {
    roles: ['business-owner', 'project-manager', 'freelancer', 'team-member'],
    key: 'project_id',
    tenantPath: [],
    userPath: [],
  },
  'task_assign.update': { roles: ['freelancer', 'team-member'], key: 'task_id', tenantPath: [], userPath: [] },
  'invoice_paid.update': {
...
const tenantRoles: string[] = ['business-owner', 'project-manager', 'freelancer', 'team-member', 'client'];
