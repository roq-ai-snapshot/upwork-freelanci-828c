...
export function SkillListPage(props: SkillListPageProps) {
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('user_skill', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'user_skill',
          header: 'User Skill',
          accessorKey: 'user_skill',
          cell: ({ row: { original: record } }: any) => record?._count?.user_skill,
        }
      : null,
