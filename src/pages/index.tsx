...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`upwork freelancing app`}</title>

        <meta
          name="description"
          content="Elevate Your Freelance Journey with Upwork Freelancing App - Discover Opportunities, Connect with Clients, and Grow Your Independent Business."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1664575197229-3bbebc281874?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxmcmVlbGFuY2luZ3xlbnwwfHx8fDE2OTUyODYzNDZ8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            <Heading mb={{ base: '12px', lg: '20px' }} size="2xl">
              {`upwork freelancing app`}
            </Heading>
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Elevate Your Freelance Journey with Upwork Freelancing App - Discover Opportunities, Connect with Clients, and Grow Your Independent Business.`}
            </Text>
            <Box
